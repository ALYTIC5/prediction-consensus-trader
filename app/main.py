...
from app.optimization.market_maker import run_market_maker_scoring_job
...
async def _run() -> None:
    ...
    try:
        ...
        jobs = [
            ...
            PeriodicJob(
                name="market_maker_scoring",
                run=run_market_maker_scoring_job,
                interval_seconds=settings.market_maker_scoring_interval_seconds,
            ),
            PeriodicJob(
                name="coherence",
